(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.RdPagination = factory());
    ...
    class RdPagination {
         ...
         *              You have to get the page number value and set its value to this class in the option "page_number_value".
         ...
         * @param {number} options.total_records The total number of records (Required). This means "all" records (maybe with sql `WHERE` conditions but..) with out the "LIMIT" or slices commands.
         * 
         ...
         * @param {string} options.page_number_type The page number type. The value can be `start_num` or `page_num`.<br>  
         *              Start number or `start_num` also know as offset number. (eg. page number value will be 0, 10, 20, 30, ...)<br>
         *              Page number or `page_num`. (eg. page number value will be 1, 2, 3, 4, ...)<br>
         *              Default is `start_num`.
         * 
         ...
         * @param {string} options.current_tag_close The current page close tag. If you set to display current page, this will be placed after link to the current page. Default is empty.
         * @param {string} options.current_tag_open The current page open tag. If you set to display current page, this will be placed before link to the current page. Default is empty.
         * 
         ...
         *              Example `{'class' => 'my class'}`. Must not contains `href`, `data-rd-pagination` attributes.
         * @param {string|false} options.first_page_text The link text of the paginate that will go to the first page. Set to `false` to not displaying first page link at all.
         * @param {string} options.first_tag_close The first page close tag. If you set to display first page, this will be placed after link to the first page. Default is 1 space.
         * @param {string} options.first_tag_open The first page open tag. If you set to display first page, this will be placed before link to the first page. Default is 1 space.
         * 
         ...
         *              Example `{'class' => 'my class'}`. Must not contains `href`, `data-rd-pagination` attributes.
         * @param {string|false} options.last_page_text The link text of the paginate that will go to the last page. Set to `false` to not displaying last page link at all.
         * @param {string} options.last_tag_close The last page close tag. If you set to display last page, this will be placed after link to the last page. Defauls is 1 space.
         * @param {string} options.last_tag_open The last page open tag. If you set to display last page, this will be placed before link to the last page. Default is 1 space.
         * 
         ...
         *              Example `{'class' => 'my class'}`. Must not contains `href`, `data-rd-pagination` attributes.
         * @param {string|false} options.next_page_text The link text of the paginate that will go to the next page. Set to `false` to not displaying next page link at all.
         * @param {string} options.next_tag_close The next page close tag. If you set to display next page, this will be placed after link to the next page. Default is 1 space.
         * @param {string} options.next_tag_open The next page open tag. If you set to display next page, this will be placed before link to the next page. Default is 1 space.
         * 
         ...
         *              Example `{'class' => 'my class'}`. Must not contains `href`, `data-rd-pagination` attributes.
         * @param {string} options.number_tag_close The page number close tag. If you set to display page number, this will be placed after link to the page number. Default is 1 space.
         * @param {string} options.number_tag_open The page number open tag. If you set to display page number, this will be placed before link to the page number. Default is 1 space.
         * 
         * @param {string} options.overall_tag_close The overall close tag. It will be place at the very end of displaying page numbers. Default is empty.
         * @param {string} options.overall_tag_open The overall open tag. It will be place at the very beginning of displaying page numbers. Default is empty.
         * 
         ...
         *              Example `{'class' => 'my class'}`. Must not contains `href`, `data-rd-pagination` attributes.
         * @param {string|false} options.previous_page_text The link text of the paginate that will go to the previous page. Set to `false` to not displaying previous page link at all.
         * @param {string} options.previous_tag_close The previous page close tag. If you set to display previous page, this will be placed after link to the previous page. Default is 1 space.
         * @param {string} options.previous_tag_open The previous page open tag. If you set to display previous page, this will be placed before link to the previous page. Default is 1 space.
         * 
         ...
         * @param {string} options.unavailable_tag_close The unavailable page close tag. If you set to display unavailable page, this will be placed after unavailable page (...). Default is 1 space.
         * @param {string} options.unavailable_tag_open The unavailable page open tag. If you set to display unavailable page, this will be placed before unavailable page (...). Default is 1 space.
        ...
        createLinks() {
            ...
            // use `reCreateLinks()` to reduce call to the same code twice or more.
            this.reCreateLinks(pagination_data);
        }// createLinks
         ...
         * This is for reduce process on method `getPaginationData()` inside `createLinks()` in case there is already one.
         * 
         * @since 0.0.4
